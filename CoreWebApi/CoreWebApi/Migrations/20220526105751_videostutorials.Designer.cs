...
namespace CoreWebApi.Migrations
{
    ...
    [Migration("20220526105751_videostutorials")]
    partial class videostutorials
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CoreWebApi.Models.ChatMessageAttachment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CoreWebApi.Models.ClassSection", b =>
                {
                    ...
                    b.HasIndex("SemesterId", "SectionId", "SchoolBranchId")
                        .IsUnique()
            ...
            modelBuilder.Entity("CoreWebApi.Models.ExamType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CoreWebApi.Models.FeeInstallment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("SemesterFeeMappingId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SemesterFeeMappingId");
            ...
            modelBuilder.Entity("CoreWebApi.Models.FeeVoucherDetail", b =>
                {
                    ...
                    b.Property<double>("ExtraChargesAmount")
                        .HasColumnType("float");

                    b.Property<string>("ExtraChargesDetails")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("CoreWebApi.Models.FeeVoucherRecord", b =>
                {
                    ...
                    b.Property<int>("AnnualOrSemesterId")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ConcessionDetails")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("VoucherDetailIds")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("CoreWebApi.Models.Group", b =>
                {
                    ...
                    b.Property<DateTime?>("GroupLectureTime")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<string>("TutorClassName")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("CoreWebApi.Models.Requisition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CoreWebApi.Models.Result", b =>
                {
                    ...
                    b.Property<string>("TutorExamName")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("CoreWebApi.Models.Semester", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("LateFeePlentyAmount")
                        .HasColumnType("int");

                    b.Property<int>("LateFeeValidityInDays")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CoreWebApi.Models.SemesterFeeMapping", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<double>("FeeAfterDiscount")
                        .HasColumnType("float");
                    ...
                    b.ToTable("SemesterFeeMappings");
                });

            modelBuilder.Entity("CoreWebApi.Models.SemesterFeeTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("SemesterFeeTransactions");
                });
            ...
            modelBuilder.Entity("CoreWebApi.Models.StudentActivityTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("StudentActivityTransactions");
                });

            modelBuilder.Entity("CoreWebApi.Models.StudentFee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CoreWebApi.Models.Subject", b =>
                {
                    ...
                    b.HasIndex("Name", "SchoolBranchId", "CreatedById")
                        .IsUnique()
            ...
            modelBuilder.Entity("CoreWebApi.Models.SubjectAssignment", b =>
                {
                    ...
                    b.HasIndex("SemesterId", "SubjectId", "SchoolBranchId")
                        .IsUnique()
                        .HasFilter("[SemesterId] IS NOT NULL");
            ...
            modelBuilder.Entity("CoreWebApi.Models.TutorAttendance", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("TutorAttendances");
                });

            modelBuilder.Entity("CoreWebApi.Models.TutorProfile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("AreasToTeach")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("CityId")
                        .HasColumnType("int");

                    b.Property<int>("CommunicationSkillRate")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("LanguageFluencyRate")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CoreWebApi.Models.TutorSubject", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CoreWebApi.Models.UsefulResource", b =>
                {
                    ...
                    b.Property<string>("ClassSectionIds")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("CoreWebApi.Models.VideosTutorials", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CoreWebApi.Models.ChatMessageAttachment", b =>
                {
                    b.HasOne("CoreWebApi.Models.Message", "MessageObj")
                        .WithMany()
            ...
            modelBuilder.Entity("CoreWebApi.Models.ClassSection", b =>
                {
                    ...
                    b.HasOne("CoreWebApi.Models.Semester", "SemesterObj")
                        .WithMany()
            ...
            modelBuilder.Entity("CoreWebApi.Models.FeeInstallment", b =>
                {
                    ...
                    b.HasOne("CoreWebApi.Models.SemesterFeeMapping", "SemesterFeeMappingObj")
                        .WithMany()
                        .HasForeignKey("SemesterFeeMappingId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("CoreWebApi.Models.FeeVoucherDetail", b =>
                {
                    b.HasOne("CoreWebApi.Models.BankAccount", "BankAccountObj")
                        .WithMany()
            ...
            modelBuilder.Entity("CoreWebApi.Models.Requisition", b =>
                {
                    b.HasOne("CoreWebApi.Models.User", "ApproveByUser")
                        .WithMany()
                        .HasForeignKey("ApproveById")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("CoreWebApi.Models.User", "RequestByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("CoreWebApi.Models.Semester", b =>
                {
                    b.HasOne("CoreWebApi.Models.User", "CreatedByObj")
                        .WithMany()
                        .HasForeignKey("CreatedById")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("CoreWebApi.Models.SchoolBranch", "SchoolBranchObj")
                        .WithMany()
                        .HasForeignKey("SchoolBranchId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("CoreWebApi.Models.SemesterFeeTransaction", b =>
                {
                    ...
                    b.HasOne("CoreWebApi.Models.User", "UpdatedByObj")
                        .WithMany()
            ...
            modelBuilder.Entity("CoreWebApi.Models.StudentFee", b =>
                {
                    ...
                    b.HasOne("CoreWebApi.Models.User", "Student")
                        .WithMany()
                        .HasForeignKey("StudentId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("CoreWebApi.Models.VideosTutorials", b =>
                {
                    b.HasOne("CoreWebApi.Models.Class", "ObjClass")
                        .WithMany()
                        .HasForeignKey("ClassId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("CoreWebApi.Models.Section", "ObjSection")
                        .WithMany()
                        .HasForeignKey("SectionId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
